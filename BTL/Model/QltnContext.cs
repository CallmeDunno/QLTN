...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-K2TUFCJ\\SQLEXPRESS;Initial Catalog=QLTN;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ChuNha>(entity =>
        {
            entity.HasKey(e => e.MaChuNha).HasName("PK__ChuNha__D13CC17F78CD379B");
        ...
        {
            entity.HasKey(e => e.MaDanhGia).HasName("PK__DanhGiaN__AA9515BF2CF54D45");
        ...
        {
            entity.HasKey(e => e.MaDichVu).HasName("PK__DichVu__C0E6DE8F1AC95DCB");
        ...
        {
            entity.HasKey(e => e.MaDtsd).HasName("PK__DoiTuong__3754306E65451314");
        ...
        {
            entity.HasKey(e => e.MaHopDong).HasName("PK__HopDongN__36DD43424A7E9FAB");
        ...
        {
            entity.HasKey(e => e.MaLoai).HasName("PK__LoaiNha__730A5759B15BBDC6");
        ...
        {
            entity.HasKey(e => e.MaMdsd).HasName("PK__MucDichS__AF4D3B05ADBE8546");
        ...
        {
            entity.HasKey(e => e.MaNguoiDung).HasName("PK__NguoiDun__C539D762C968D684");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__QuanTriV__3214EC277617713C");
        ...
        {
            entity.HasKey(e => e.MaTaiSan).HasName("PK__TaiSan__8DB7C7BEBF8E0F01");
        ...
        {
            entity.HasKey(e => e.MaNha).HasName("PK__ThongTin__3A18F65FE5C1277D");
